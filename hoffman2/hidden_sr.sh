...
# One task = one ticker. Emits results/hidden_sr/out/$TK.csv.
set -uo pipefail
...
GD=results/hidden_sr; PAR=6; L=nicjia@lobster2.math.ucla.edu
...
work(){
  dd=$1; TK=$2; L=nicjia@lobster2.math.ucla.edu; GD=results/hidden_sr
