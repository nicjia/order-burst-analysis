...
# One task = one ticker. Emits results/harall/out/$TK.csv.
set -uo pipefail
...
GD=results/harall; PAR=6; L=nicjia@lobster2.math.ucla.edu
...
work(){
  dd=$1; TK=$2; L=nicjia@lobster2.math.ucla.edu; GD=results/harall
