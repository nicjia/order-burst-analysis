...
# One task = one ticker. Emits results/ideas2/out/$TK.csv.
set -uo pipefail
...
GD=results/ideas2; PAR=6; L=nicjia@lobster2.math.ucla.edu
...
work(){
  dd=$1; TK=$2; L=nicjia@lobster2.math.ucla.edu; GD=results/ideas2
