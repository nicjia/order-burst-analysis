...
# NOTE: before submitting, regenerate results/pit_rev/universe.txt from the LIVE
...
work(){
  dd=$1; TK=$2; L=nicjia@lobster2.math.ucla.edu; GD=results/pit_rev
